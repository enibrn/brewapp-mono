...
- [x] **Implementazione Componente Base:** Tradurre il blueprint Vue fornito nel `ideas-dump.md` e inserirlo in un layout dedicato (`layouts/default.vue`).
- [x] **Componenti Vuetify:** Inserire `v-system-bar`, `v-app-bar`, `v-navigation-drawer` e `v-main` secondo lo schema.
- [x] **Icona Utente e Menu a tendina:** 
...
- [x] **Astrazione dei Servizi (Monolite Modulare):**
...
- [x] **Implementazione dei Metodi Dummy:**
...
- [x] **Setup Framework:** Installare e configurare un framework di test E2E
...
- [x] **Verifica:** Assicurarsi che tutti i test passino usando l'implementazione dummy creata.
